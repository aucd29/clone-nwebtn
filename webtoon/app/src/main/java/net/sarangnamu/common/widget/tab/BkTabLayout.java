...
/**
 * Created by <a href="mailto:aucd29@gmail.com">Burke Choi</a> on 2016. 8. 10.. <p/>
 *
 * FIXME
 * - DEFAULT_HEIGHT_WITH_TEXT_ICON 값을 72 -> 55 로 변경
 * - DEFAULT_GAP_TEXT_ICON 값을 8 -> 3 으로 변경
 * - tabIndicatorHeight 값이 0이면 높이 값을 parent 에 맞추게 하고 tab 의 background color 를 설저 하지 않도록 수정
 */
public class BkTabLayout extends HorizontalScrollView {
    private static final org.slf4j.Logger mLog = org.slf4j.LoggerFactory.getLogger(BkTabLayout.class);

    private static final int DEFAULT_HEIGHT_WITH_TEXT_ICON = 55; //72; // dps
    ...
    /**
     * Gravity used to fill the {@link BkTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link BkTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private Paint mSeparatorPt;

    public BkTabLayout(Context context) {
        this(context, null);
    }

    public BkTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BkTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        ThemeUtils.checkAppCompatTheme(context);
     ...
     *
     * @attr ref android.support.design.R.styleable#BkTabLayout_tabIndicatorColor
     */
     ...
     *
     * @attr ref android.support.design.R.styleable#BkTabLayout_tabIndicatorHeight
     */
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to a different BkTabLayout.");
        }
    ...
    /**
     * Add a {@link BkTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link BkTabLayout.OnTabSelectedListener} that was previously added via
    ...
    public void removeTab(Tab tab) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab does not belong to this BkTabLayout.");
        }
     ...
     *
     * @attr ref android.support.design.R.styleable#BkTabLayout_tabMode
     */
    ...
    /**
     * Returns the current mode used by this {@link BkTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
     ...
     *
     * @attr ref android.support.design.R.styleable#BkTabLayout_tabGravity
     */
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref android.support.design.R.styleable#BkTabLayout_tabTextColor
     * @attr ref android.support.design.R.styleable#BkTabLayout_tabSelectedTextColor
     */
    ...
    /**
     * The one-stop shop for setting up this {@link BkTabLayout} with a {@link ViewPager}.
     *
     ...
     * The one-stop shop for setting up this {@link BkTabLayout} with a {@link ViewPager}.
     *
     * <p>This method will link the given ViewPager and this BkTabLayout together so that
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(ViewPager)} to link a BkTabLayout with a ViewPager
     *             together. When that method is used, the BkTabLayout will be automatically updated
    ...
    private void addViewInternal(final View child) {
        if (child instanceof TabItem) {
            ...
            throw new IllegalArgumentException("Only TabItem instances can be added to BkTabLayout");
        }
    }
    ...
    public void setSeparatorPosition(SeparatorPosition position, int color) {
        if (position == SeparatorPosition.NONE) {
            mSeparatorPt = null;
        } else {
            mSeparatorPt = new Paint();
            mSeparatorPt.setColor(color);
            mSeparatorPt.setStrokeWidth(dpToPx(1));
        }
    }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context) {
            super(context);
            if (mTabBackgroundResId != 0 && mTabStrip.getSelectedIndicatorHeight() != 0) {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        int getSelectedIndicatorHeight() {
     ...
     * necessary calls back to the provided {@link BkTabLayout} so that the tab position is
     * kept in sync.
     *
     * <p>This class stores the provided BkTabLayout weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BkTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(BkTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final BkTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link BkTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements BkTabLayout.OnTabSelectedListener {
    ...
    static class TabItem extends View {
